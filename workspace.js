...
cpdefine("inline:com-chilipeppr-workspace-tinyg-webcam", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-tinyg-webcam", // Make the id the same as the cpdefine id
        name: "Workspace / TinyG-WebCam", // The descriptive name of your widget.
       ...
       this.cncUtilitiesObj = function() {
                return {
                    name: "cncUtilitie",
                    url: "http://raw.githubusercontent.com/robertleelittleiii/widget-template/master/auto-generated-widget.html",
                    id: "com-chilipeppr-widget-cncutilities",
                    btn: $('#com-chilipeppr-ws-menu .cncutilities-button'),
                    div: $('#com-chilipeppr-ws-cncutilities'),
                    instance: null,
                    init: function() { 
                        this.btn.click(this.toggle.bind(this));
                    ...
                    show: function() {
                        ...
                        if (this.instance != null) {
                            console.log("activating " + this.name + " instead of re-instantiating cuz already created");
                            // this.instance.activate();
                            // activate not used, but we may want to use it for loading the saved settings.        
                            //if (callback) callback(this.instance);
                        }
                        else {
                            // otherwise, dynamic load
